...
s32 Map_s32(MAP_T * Copy_puMAP_T_Map_config, s32 Copy_s32InputValue) {
	...
	if(Local_s32Output < Copy_puMAP_T_Map_config ->OutputRangeMinimum) {
		Local_s32Output = Copy_puMAP_T_Map_config ->OutputRangeMinimum;
	}

	if(Local_s32Output > Copy_puMAP_T_Map_config ->OutputRangeMaximum) {
		Local_s32Output = Copy_puMAP_T_Map_config ->OutputRangeMaximum ;
	}
